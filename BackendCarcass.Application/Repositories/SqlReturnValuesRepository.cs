...
public sealed class SqlReturnValuesRepository(ICarcassApplicationDbContext ctx) : ReturnValuesRepository(ctx)
{
    private readonly ICarcassApplicationDbContext _ctx = ctx;
